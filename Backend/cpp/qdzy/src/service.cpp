...
void Service::count(
  ...
  std::string stmt = "SELECT COUNT(id) FROM qdzy_service WHERE \"delete\" = 0";
...
void Service::list(
  ...
  std::string stmt = "SELECT * FROM qdzy_service WHERE \"delete\" = 0";
...
void Service::info(
  ...
  auto db = app().getDbClient("postgresql-slave");
  db->execSqlAsync(
      "SELECT * FROM qdzy_service WHERE \"delete\" = 0 AND \"id\" = $1",
      [=](const orm::Result &r) {
        Json::Value ret;
        Json::Value info;
...
void Service::create(
  ...
  db->execSqlAsync(
      "INSERT INTO qdzy_service VALUES ($1, $2, $3, $4, $5, $6)",
      [=](const orm::Result &r) {
        Json::Value ret;
...
void Service::update(
  ...
  case Put: {
    db->execSqlAsync(
        "UPDATE qdzy_service SET name = $1, update_date = $2, update_user = $3 "
        "WHERE \"id\" = $4",
        [=](const orm::Result &r) {
          Json::Value ret;
  ...
  case Delete: {
    db->execSqlAsync(
        "UPDATE qdzy_service SET delete = 1 WHERE \"id\" = $1",
        [=](const orm::Result &r) {
          Json::Value ret;
