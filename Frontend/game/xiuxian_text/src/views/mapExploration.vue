    ...
    >
      <div class="game-container">
        ...
        <el-button
          ...
          class="button"
        >
          钓鱼<span class="shortcutKeys"
            >({{ holdingId ? "松开" : "长按" }})</span
          >
        </el-button>
      </div>
    </el-drawer>
...
export default {
  ...
  methods: {
    ...
    harvestNpc(item) {
      this.$confirm(
        "与对方结为道侣有50%的概率失败, 失败后好感度会清空, 请问还想与对方结为道侣吗?",
        "结为道侣",
        {
          center: true,
          cancelButtonText: "取消",
      ...
      if (this.fishing.score >= maxScore && !this.fishing.gameOver) {
        ...
        this.$confirm(fishInfo.description, fishInfo.name, {
          ...
          .then(() => {
            ...
            this.$notifys({
              title: "提示",
              message: `你获得了${fishInfo.price}灵石`,
              position: "top-left",
            });
          })
          .catch(() => {});
      ...
      const fishList = [
        {
          name: "金鳞鲤鱼",
          price: 100,
          description: "金色鳞片的鲤鱼，象征着好运和财富。",
          probability: 0.25,
        },
        {
          name: "青铜鲑鱼",
          price: 150,
          description: "体型健硕的鲑鱼，常出现在清凉的河流中。",
          probability: 0.2,
        },
        {
          name: "冰川鳟鱼",
          price: 200,
          description: "来自寒冷冰川地区的鳟鱼，肉质鲜美。",
          probability: 0.18,
        },
        {
          name: "红尾锦鲤",
          price: 300,
          description: "具有漂亮红色尾巴的锦鲤，观赏价值极高。",
          probability: 0.15,
        },
        {
          name: "银鳍鲢鱼",
          price: 80,
          description: "常见于淡水湖泊，银色鳍片在水中闪闪发光。",
          probability: 0.3,
        },
        {
          name: "巨口鲶鱼",
          price: 180,
          description: "以其巨大的嘴巴和强劲的咬力著称，肉质肥美。",
          probability: 0.17,
        },
        {
          name: "幽蓝灯鱼",
          price: 250,
          description: "深海中发出幽蓝光芒的小型鱼类，具有神秘色彩。",
          probability: 0.14,
        },
        {
          name: "翡翠剑鱼",
          price: 500,
          description: "剑形的鱼嘴和翡翠般的色彩让它成为海中战士。",
          probability: 0.08,
        },
        {
          name: "斑点鲈鱼",
          price: 90,
          description: "遍布斑点的鲈鱼，适应力极强，分布广泛。",
          probability: 0.28,
        },
        {
          name: "火焰红鱼",
          price: 400,
          description: "拥有火焰般红色鳞片的稀有鱼类，价格不菲。",
          probability: 0.1,
        },
        {
          name: "雷电鳗鱼",
          price: 350,
          description: "全身带有微弱电流的鳗鱼，捕食时能够电击猎物。",
          probability: 0.12,
        },
        {
          name: "黑甲鲨",
          price: 600,
          description: "身披黑色盔甲般鳞片的鲨鱼，充满攻击性。",
          probability: 0.06,
        },
        {
          name: "水晶鲤鱼",
          price: 120,
          description: "鳞片透明的鲤鱼，在阳光下晶莹剔透。",
          probability: 0.22,
        },
        {
          name: "紫鳍金枪鱼",
          price: 700,
          description: "金枪鱼中的顶级品种，因其紫色鳍而得名。",
          probability: 0.05,
        },
        {
          name: "珍珠贝鱼",
          price: 220,
          description: "外形酷似贝壳的鱼类，藏有珍珠般的光泽。",
          probability: 0.16,
        },
        {
          name: "蓝鲸鱼苗",
          price: 1000,
          description: "蓝鲸的幼年鱼苗，体积虽小但潜力巨大。",
          probability: 0.03,
        },
        {
          name: "彩虹鳟鱼",
          price: 280,
          description: "彩虹般斑斓的鳟鱼，深受垂钓者喜爱。",
          probability: 0.13,
        },
        {
          name: "毒针河豚",
          price: 150,
          description: "体型小但带有剧毒的河豚，需小心处理。",
          probability: 0.2,
        },
        {
          name: "黄金海马",
          price: 500,
          description: "稀有的海马品种，金黄色的身体闪闪发光。",
          probability: 0.08,
        },
        {
          name: "深海魔鱼",
          price: 800,
          description: "生活在深海中的巨大鱼类，外表极具威胁性。",
          probability: 0.04,
        },
      ];
      // 遍历鱼类列表，根据概率抽取鱼
