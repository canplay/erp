          ...
          <q-slide-transition>
            <q-card v-show="search.visible" style="margin-top: 8px">
              <q-card-section class="row">
                <div class="col">
                  <div class="row">
                    <q-input outlined class="col" v-model="search.content" label="说明" />

                    <div class="col-auto" style="width: 8px" />

                    <q-input outlined class="col" v-model="search.content" label="建设公司" />

                    <div class="col-auto" style="width: 8px" />

                    <q-input outlined class="col" v-model="search.content" label="运营公司" />
                  </div>
  ...
  <q-dialog v-model="dialog.model" persistent>
    <q-card style="min-width: 400px; max-width: 90vw">
      <q-toolbar class="bg-primary text-white">
        <q-toolbar-title>新增项目</q-toolbar-title>
      ...
      >
        ...
        <q-card bordered>
          <q-card-section>
            ...
            <q-input outlined v-model="search.content" label="建设公司" />

            <div style="height: 8px" />

            <q-input outlined v-model="search.content" label="运营公司" />
          </q-card-section>
        </q-card>
        ...
        <q-card bordered>
          <q-card-section>
            <div class="text-h6">投资信息</div>

            <div style="height: 8px" />

            <q-input outlined v-model="search.content" label="总投资金" />

            <div style="height: 8px" />

            <q-input outlined v-model="search.content" label="自投资金" />

            <div style="height: 8px" />

            <q-input outlined v-model="search.content" label="贷款资金" />

            <div style="height: 8px" />

            <q-input outlined v-model="search.content" label="补贴资金" />
          </q-card-section>
        </q-card>
...
const columns = <QTableProps['columns']>[
  ...
  },
  {
    ...
    label: '建设公司',
    align: 'center',
    field: 'create_company',
    sortable: true,
  },
  { name: 'use_company', label: '运营公司', align: 'center', field: 'use_company', sortable: true },
...
interface RowData {
  name: string;
  desc: number | string;
  create_company: number | string;
  use_company: number | string;
...
const onExport = () => {
  ...
  const status = exportFile('项目列表.csv', content, 'text/csv');
